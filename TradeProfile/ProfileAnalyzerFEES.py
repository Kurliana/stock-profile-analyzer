...
class ProfileAnalyserFEES(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[100000, 102000, 110000, 180000, -1, 0, 0.02, 4, 'take_innsta_0.02'],
                    1:[100000, 101000, 103000, 154000, -1, 0, 0.02, 3, 'take_innsta_0.015'],
                    2:[100000, 101000, 103000, 180000, -1, 0, 0.02, 4, 'take_innsta_0.03'],
                    3:[100000, 105000, 112000, 172000, -1, 0, 0.04, 2, 'take_innsta_0.0075'],
                    4:[100000, 101000, 102000, 173000, -1, 0, 0.03, 4, 'take_innsta_0.04'],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
