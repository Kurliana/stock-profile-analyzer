...
class ProfileAnalyserFEES(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek(self,curr_date):
        ...
        day_ranges={0:[100000, 102000, 104000, 171000, -1, 0, 0.03, 5, 'take_innsta_0.02', 9, 0],
                    1:[100000, 103000, 104000, 174000, -1, 0, 0.03, 4, 'take_innsta_0.02', 9, 14],
                    2:[100000, 103000, 104000, 180000, -1, 0, 0.01, 4, 'take_innsta_0.03', 9, 14],
                    3:[100000, 104000, 105000, 173000, -1, 0, 0.01, 5, 'take_innsta_0.03', 9, 14],
                    4:[100000, 101000, 102000, 173000, -1, 0, 0.03, 4, 'take_innsta_0.04', 0, 0],
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[[100000, 102000, 105000, 180000, -1, 0, 0.01, 5, 'take_innsta_0.0075', 14, 20],[100000, 102000, 113000, 180000, 1, 0, 0.02, 4, 'take_innsta_0.0075', 14, 20]],
                    1:[[100000, 103000, 104000, 174000, -1, 0, 0.03, 4, 'take_innsta_0.02', 9, 14],[100000, 103000, 115000, 180000, 1, 0, 0.04, 3, 'take_innsta_0.01', 9, 14]],
                    2:[[100000, 103000, 104000, 180000, -1, 0, 0.01, 4, 'take_innsta_0.03', 9, 27, 32],[100000, 103000, 105000, 180000, 1, 0, 0.04, 3, 'take_innsta_0.003', 9, 27]],
                    3:[[100000, 110000, 114000, 180000, -1, 0, 0.03, 3, 'take_innsta_0.0075', 20, 0],[100000, 110000, 135000, 174000, 1, 0, 0.03, 2, 'take_innsta_0.01', 20, 0]],
...
if __name__ == "__main__":
    ...
    result_files=["C:\\Just2Trade Client\\FGC UES.txt","C:\\Just2Trade Client\\reserv_FGC UES.txt"]
