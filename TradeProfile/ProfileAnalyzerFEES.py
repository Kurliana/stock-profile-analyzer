...
class ProfileAnalyserFEES(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek(self,curr_date):
        ...
        day_ranges={0:[100000, 101000, 102000, 175000, 1, 0, 0.04, 3, 'take_innsta_0.015', 27, 0],
                    1:[100000, 101000, 102000, 175000, 1, 0, 0.04, 3, 'take_innsta_0.01', 27, 0],
                    2:[100000, 101000, 102000, 175000, 1, 0, 0.04, 3, 'take_innsta_0.03', 27, 0],
                    3:[100000, 101000, 102000, 175000, 1, 0, 0.04, 4, 'take_innsta_0.015', 27, 0],
                    4:[100000, 101000, 102000, 175000, 1, 0, 0.04, 10, 'take_innsta_0.04', 27, 0],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
