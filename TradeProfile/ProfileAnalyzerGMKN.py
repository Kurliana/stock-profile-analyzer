...
class ProfileAnalyserGMKN(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek(self,curr_date):
        ...
        day_ranges={0:[100000, 105000, 110000, 174000, -1, 0, 0.02, 3, 'take_innsta_0.01', 20, 0],
                    1:[100000, 104000, 110000, 174000, -1, 0, 0.01, 3, 'take_innsta_0.02', 0, 0],
                    2:[100000, 103000, 110000, 180000, -1, 0, 0.01, 4, 'take_innsta_0.03', 14, 0],
                    3:[100000, 103000, 104000, 170000, -1, 0, 0.01, 4, 'take_innsta_0.015', 9, 20],
