...
class ProfileAnalyserGMKN(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek(self,curr_date):
        ...
        day_ranges={0:[100000, 101000, 102000, 142000, 1, 0, 0.04, 10, 'take_innsta_0.03', 27, 0],
                    1:[100000, 101000, 102000, 145000, 1, 0, 0.03, 0, 'take_innsta_0.04', 14, 27],
                    2:[100000, 113000, 114000, 142000, 1, 0, 0.04, 10, 'take_innsta_0.03', 27, 0],
                    3:[100000, 114000, 115000, 154000, 1, 0, 0.03, 0, 'take_innsta_0.02', 27, 0],
                    4:[100000, 104000, 105000, 133000, 1, 0, 0.04, 10, 'take_innsta_0.015', 27, 0],
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[[100000, 102000, 105000, 180000, -1, 0, 0.04, 4, 'take_innsta_0.01', 9, 0],[]],
                    1:[[100000, 104000, 105000, 180000, -1, 0, 0.01, 3, 'take_innsta_0.01', 9, 27],[100000, 104000, 123000, 175000, 1, 0, 0.03, 3, 'take_innsta_0.02', 9, 27]],
                    2:[[100000, 101000, 102000, 175000, -1, 0, 0.01, 3, 'take_innsta_0.04', 20, 0],[100000, 101000, 115000, 180000, 1, 0, 0.04, 3, 'take_innsta_0.03', 20, 0]],
                    3:[[100000, 101000, 104000, 180000, -1, 0, 0.01, 3, 'take_innsta_0.003', 14, 0],[100000, 101000, 112000, 161000, 1, 0, 0.03, 3, 'take_innsta_0.03', 14, 0]],
                    4:[[100000, 103000, 104000, 173000, -1, 0, 0.03, 3, 'take_innsta_0.015', 9, 0],[]],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
...
if __name__ == "__main__":
    ...
    result_files=["C:\\Just2Trade Client\\Nornickel.txt","C:\\Just2Trade Client\\reserv_Nornickel.txt"]
