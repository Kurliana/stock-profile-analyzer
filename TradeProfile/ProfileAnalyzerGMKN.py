...
class ProfileAnalyserGMKN(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[100000, 111000, 123000, 172000, -1, 0, 0.03, 1, 'take_innsta_0.015', 9, 27],
                    1:[100000, 101000, 102000, 144000, 1, 0, 0.04, 1, 'take_innsta_0.04', 14, 27],
                    2:[100000, 104000, 110000, 175000, -1, 0, 0.03, 1, 'take_innsta_0.03', 9, 27],
                    3:[100000, 112000, 115000, 152000, 1, 0, 0.03, 1, 'take_innsta_0.02', 27, 0],
                    4:[100000, 102000, 122000, 173000, 1, 0, 0.04, 1, 'take_innsta_0.02', 14, 27],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
