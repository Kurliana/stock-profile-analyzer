...
class ProfileAnalyserGMKN(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        ...
        day_ranges={0:[[100000, 102000, 105000, 180000, -1, 0, 0.04, 4, 'take_innsta_0.01', 9, 0]],
                    1:[[100000, 102000, 103000, 180000, -1, 0, 0.03, 4, 'take_innsta_0.01', 20, 0],[100000, 102000, 122000, 175000, 1, 0, 0.01, 3, 'take_innsta_0.03', 20, 0]],
                    2:[[100000, 104000, 110000, 180000, -1, 0, 0.01, 4, 'take_innsta_0.03', 9, 27],[100000, 104000, 115000, 180000, 1, 0, 0.04, 3, 'take_innsta_0.03', 9, 27]],
                    3:[[100000, 102000, 110000, 171000, -1, 0, 0.01, 4, 'take_innsta_0.015', 20, 0],[100000, 102000, 104000, 173000, 1, 0, 0.02, 2, 'take_innsta_0.03', 20, 0]],
                    4:[[100000, 103000, 104000, 173000, -1, 0, 0.03, 3, 'take_innsta_0.015', 9, 0]],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
