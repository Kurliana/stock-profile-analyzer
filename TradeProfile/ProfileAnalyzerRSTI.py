...
class ProfileAnalyserRSTI(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[[100000, 102000, 103000, 180000, -1, 0, 0.02, 5, 'take_innsta_0.003', 9, 20],[100000, 102000, 133000, 170000, 1, 0, 0.04, 4, 'take_innsta_0.01', 9, 20]],
                    1:[[100000, 110000, 111000, 174000, -1, 0, 0.02, 4, 'take_innsta_0.0075', 27, 0],[100000, 110000, 134000, 165000, 1, 0, 0.01, 2, 'take_innsta_0.005', 27, 0]],
                    ...
                    3:[[100000, 123000, 132000, 174000, -1, 0, 0.02, 5, 'take_innsta_0.03', 20, 27],[100000, 123000, 124000, 142000, 1, 0, 0.03, 3, 'take_innsta_0.0075', 20, 27]],
                    4:[[100000, 110000, 113000, 175000, -1, 0, 0.02, 5, 'take_innsta_0.02', 9, 0],[100000, 110000, 140000, 171000, 1, 0, 0.02, 3, 'take_innsta_0.005', 9, 0]],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
...
if __name__ == "__main__":
    ...
    result_files=["C:\\Just2Trade Client\\Rosseti.txt","C:\\Just2Trade Client\\reserv_Rosseti.txt"]
