...
class ProfileAnalyserMOEX(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        ...
        day_ranges={0:[[183000, 183000, 183000, 183000,1],[]],
                    1:[[100000, 125000, 130000, 173000, 1, 0, 0.04, 5, 'take_innsta_0.02', 9, 0],[]],
                    2:[[100000, 101000, 121000, 170000, -1, 0, 0.04, 10, 'take_innsta_0.04', 14, 0],[]],
                    3:[[183000, 183000, 183000, 183000,1],[]],
                    4:[[100000, 130000, 135000, 173000, -1, 0, 0.02, 4, 'take_innsta_0.02', 9, 14],[]],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
