...
logging.config.fileConfig('log_moex.conf')
log=logging.getLogger('main')
from ProfileAnalyzer import ProfileAnalyser

class ProfileAnalyserMOEX(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[[100000, 102000, 103000, 134000, -1, 0, 0.04, 3, 'take_innsta_0.03', 9, 0],[100000, 102000, 131000, 163000, 1, 0, 0.01, 3, 'take_innsta_0.0075', 9, 0]],
                    1:[[100000, 103000, 115000, 180000, 1, 0, 0.03, 5, 'take_innsta_0.03', 9, 27],[100000, 103000, 104000, 180000, -1, 0, 0.01, 5, 'take_innsta_0.01', 9, 27]],
                    2:[[100000, 101000, 102000, 150000, -1, 0, 0.03, 2, 'take_innsta_0.02', 9, 0],[100000, 101000, 105000, 145000, 1, 0, 0.03, 2, 'take_innsta_0.0075', 9, 0]],
                    3:[[100000, 103000, 113000, 172000, -1, 0, 0.02, 3, 'take_innsta_0.01', 9, 14],[100000, 103000, 133000, 165000, 1, 0, 0.02, 3, 'take_innsta_0.04', 9, 14]],
                    4:[[100000, 103000, 104000, 173000, -1, 0, 0.03, 5, 'take_innsta_0.015', 9, 20],[]],
...
if __name__ == "__main__":
    ...
    temp_file_name="daily_MOEX.txt"
    result_files=["C:\\Just2Trade Client\\Moskovskaya Birzha.txt","C:\\Just2Trade Client\\reserv_Moskovskaya Birzha.txt"]
    ...
    pa = ProfileAnalyserMOEX(temp_file_name)
