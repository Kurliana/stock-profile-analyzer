...
class ProfileAnalyserALRS(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek(self,curr_date):
        ...
        day_ranges={0:[100000, 102000, 103000, 153000, -1, 0, 0.03, 4, 'take_innsta_0.015', 14, 0],
                    1:[100000, 102000, 111000, 180000, -1, 0, 0.04, 5, 'take_innsta_0.0075', 20, 27],
                    2:[100000, 111000, 112000, 172000, -1, 0, 0.02, 3, 'take_innsta_0.02', 9, 0],
                    3:[100000, 101000, 104000, 180000, -1, 0, 0.04, 3, 'take_innsta_0.0075', 0 ,0],
                    4:[100000, 102000, 104000, 165000, -1, 0, 0.02, 4, 'take_innsta_0.02', 9, 0],
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[[100000, 102000, 105000, 180000, -1, 0, 0.04, 4, 'take_innsta_0.015', 27, 0],[100000, 102000, 104000, 175000, 1, 0, 0.01, 4, 'take_innsta_0.0075', 27, 0]],
                    1:[[100000, 101000, 102000, 180000, -1, 0, 0.02, 5, 'take_innsta_0.02', 14, 27],[100000, 101000, 103000, 143000, 1, 0, 0.04, 5, 'take_innsta_0.04', 14, 27]],
                    2:[[100000, 101000, 102000, 174000, -1, 0, 0.04, 4, 'take_innsta_0.015', 9, 0],[100000, 101000, 103000, 172000, 1, 0, 0.02, 4, 'take_innsta_0.005', 9, 0]],
                    3:[[100000, 101000, 104000, 180000, -1, 0, 0.04, 3, 'take_innsta_0.0075', 0 ,0],[]],
                    4:[[100000, 102000, 104000, 164000, -1, 0, 0.02, 4, 'take_innsta_0.02', 20, 0],[100000, 102000, 130000, 175000, 1, 0, 0.03, 4, 'take_innsta_0.005', 20, 0]],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
