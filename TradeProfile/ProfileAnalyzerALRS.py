...
class ProfileAnalyserALRS(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[100000, 103000, 105000, 180000, -1, 0.0015, 0.04, 4, 'take_innsta_0.015'],
                    1:[100000, 102000, 103000, 164000, 1, 0, 0.04, 4, 'take_innsta_0.04'],
                    2:[100000, 104000, 110000, 180000, -1, 0.0015, 0.02, 3, 'take_innsta_0.02'],
                    3:[100000, 101000, 104000, 180000, -1, 0, 0.04, 3, 'take_innsta_0.0075'],
                    4:[100000, 114000, 115000, 180000, -1, 0.0015, 0.04, 4, 'take_innsta_0.04'],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
...
if __name__ == "__main__":
    ...
    result_file="C:\Just2Trade Client\AK Alrosa.txt"
