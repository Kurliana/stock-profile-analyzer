...
class NNTrader():
    ...
    def __init__(self, model_path = "nn_trade_test_model4.h5", init_model = True):
...
if __name__ == "__main__":
    ...
    try:
        for filename in os.listdir("C:\\Just2Trade Client\\"):
            if filename.find("tickers_") >= 0 and filename.find("tickers_BTCUSD") !=0:
                #nnt.prepare_data("C:\\Just2Trade Client\\"+filename,"world")
                print filename
                nnt.prepare_data("C:\\Just2Trade Client\\tickers_BTCUSD.txt","world")
