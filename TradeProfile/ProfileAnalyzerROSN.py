...
class ProfileAnalyserROSN(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[[100000, 101000, 102000, 173000, -1, 0, 0.04, 3, 'take_innsta_0.0075', 27, 0],[100000, 101000, 110000, 175000, 1, 0, 0.03, 3, 'take_innsta_0.02', 27, 0]],
                    1:[[100000, 101000, 102000, 180000, -1, 0, 0.04, 4, 'take_innsta_0.003', 14, 20],[100000, 101000, 104000, 170000, 1, 0, 0.04, 4, 'take_innsta_0.04', 14, 20]],
                    2:[[100000, 101000, 120000, 174000, -1, 0, 0.04, 3, 'take_innsta_0.04', 14, 20],[100000, 101000, 102000, 133000, 1, 0, 0.01, 3, 'take_innsta_0.0075', 14, 20]],
                    3:[[100000, 102000, 123000, 180000, -1, 0, 0.03, 5, 'take_innsta_0.02', 20, 0],[100000, 102000, 104000, 141000, 1, 0, 0.01, 5, 'take_innsta_0.04', 20, 0]],
                    4:[[100000, 102000, 141000, 171000, -1, 0, 0.04, 4, 'take_innsta_0.01', 9, 14],[100000, 102000, 110000, 165000, 1, 0, 0.04, 4, 'take_innsta_0.04', 9, 14]],
