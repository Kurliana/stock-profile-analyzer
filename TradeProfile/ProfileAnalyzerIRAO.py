...
class ProfileAnalyserIRAO(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[100000, 122000, 144000, 175000, 1, 0, 0.04, 1, 'take_innsta_0.04', 9, 20],
                    1:[100000, 101000, 102000, 135000, 1, 0, 0.04, 1, 'take_innsta_0.03', 20, 0],
                    2:[100000, 101000, 111000, 175000, -1, 0, 0.04, 1, 'take_innsta_0.015', 27, 0],
                    3:[100000, 132000, 133000, 175000, 1, 0, 0.04, 1, 'take_innsta_0.01', 9, 27],
                    4:[100000, 143000, 145000, 165000, 1, 0, 0.04, 0, 'take_innsta_0.03', 27, 0],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
