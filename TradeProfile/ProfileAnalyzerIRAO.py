...
class ProfileAnalyserIRAO(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek(self,curr_date):
        ...
        day_ranges={0:[100000, 115000, 121000, 163000, 1, 0, 0.04, 5, 'take_innsta_0.03', 9, 27],
                    1:[100000, 101000, 102000, 135000, 1, 0, 0.04, 0, 'take_innsta_0.03', 20, 0],
                    2:[100000, 101000, 121000, 164000, -1, 0, 0.04, 1, 'take_innsta_0.03', 27, 0],
                    3:[100000, 131000, 132000, 173000, 1, 0, 0.04, 5, 'take_innsta_0.02', 9, 27],
                    4:[100000, 143000, 145000, 165000, 1, 0, 0.04, 0, 'take_innsta_0.03', 27, 0],
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[[100000, 102000, 103000, 175000, -1, 0, 0.03, 4, 'take_innsta_0.003', 14, 0],[100000, 102000, 141000, 170000, 1, 0, 0.01, 4, 'take_innsta_0.03', 14, 0]],
                    1:[[100000, 104000, 110000, 180000, -1, 0, 0.04, 5, 'take_innsta_0.0075', 20, 0],[]],
                    ...
                    3:[[100000, 102000, 113000, 180000, -1, 0, 0.04, 5, 'take_innsta_0.03', 20, 0],[100000, 102000, 140000, 180000, 1, 0, 0.01, 5, 'take_innsta_0.015', 20, 0]],
                    4:[[100000, 101000, 102000, 145000, 1, 0, 0.04, 2, 'take_innsta_0.015', 14, 27],[100000, 101000, 110000, 172000, -1, 0, 0.02, 2, 'take_innsta_0.003', 14, 27]],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
