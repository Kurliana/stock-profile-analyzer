...
class ProfileAnalyserNVTK(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[[100000, 101000, 102000, 180000, -1, 0, 0.01, 3, 'take_innsta_0.003', 27, 0],[100000, 101000, 112000, 142000, 1, 0, 0.01, 3, 'take_innsta_0.03', 27, 0]],
                    1:[[100000, 102000, 103000, 172000, -1, 0, 0.04, 3, 'take_innsta_0.0075', 20, 27],[100000, 102000, 115000, 180000, 1, 0, 0.04, 3, 'take_innsta_0.015', 20, 27]],
                    2:[[100000, 101000, 102000, 180000, -1, 0, 0.04, 3, 'take_innsta_0.0075', 20, 0]],
                    3:[[100000, 101000, 104000, 174000, -1, 0, 0.02, 4, 'take_innsta_0.0075', 9, 0],[100000, 101000, 121000, 151000, 1, 0, 0.04, 4, 'take_innsta_0.015', 9, 0]],
                    4:[[100000, 103000, 104000, 180000, -1, 0, 0.02, 4, 'take_innsta_0.005', 20, 0],[100000, 103000, 142000, 180000, 1, 0, 0.04, 4, 'take_innsta_0.0075', 20, 0]],
...
if __name__ == "__main__":
    ...
    temp_file_name="daily_NVTK.txt"
    result_files=["C:\\Just2Trade Client\\Novatek.txt","C:\\Just2Trade Client\\reserv_Novatek.txt"]
    ...
    pa = ProfileAnalyserNVTK(temp_file_name)
