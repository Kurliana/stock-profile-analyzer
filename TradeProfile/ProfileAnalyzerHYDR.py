...
logging.config.fileConfig('log_hydr.conf')
log=logging.getLogger('main')
from ProfileAnalyzer import ProfileAnalyser

class ProfileAnalyserHYDR(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[[100000, 103000, 104000, 175000, -1, 0, 0.03, 3, 'take_innsta_0.003', 27, 0],[100000, 103000, 152000, 175000, 1, 0, 0.04, 3, 'take_innsta_0.005', 27, 0]],
                    1:[[100000, 101000, 104000, 162000, -1, 0, 0.03, 3, 'take_innsta_0.01', 9, 27],[100000, 101000, 122000, 180000, 1, 0, 0.02, 3, 'take_innsta_0.003', 9, 27]],
                    2:[[100000, 102000, 103000, 175000, -1, 0, 0.04, 4, 'take_innsta_0.005', 20, 0],[100000, 102000, 163000, 180000, 1, 0, 0.03, 4, 'take_innsta_0.0075', 20, 0]],
                    3:[[100000, 103000, 104000, 173000, -1, 0, 0.01, 3, 'take_innsta_0.02', 9, 0],[100000, 103000, 135000, 171000, 1, 0, 0.03, 3, 'take_innsta_0.005', 9, 0]],
                    4:[[100000, 104000, 110000, 180000, -1, 0, 0.04, 3, 'take_innsta_0.005', 9, 0],[100000, 104000, 154000, 180000, 1, 0, 0.02, 3, 'take_innsta_0.03', 9, 0]],
...
if __name__ == "__main__":
    ...
    temp_file_name="daily_HYDR.txt"
    result_files=["C:\\Just2Trade Client\\Rushydro.txt","C:\\Just2Trade Client\\reserv_Rushydro.txt"]
    ...
    pa = ProfileAnalyserHYDR(temp_file_name)
