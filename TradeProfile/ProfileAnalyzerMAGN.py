...
class ProfileAnalyserMAGN(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[100000, 112000, 121000, 172000, -1, 0, 0.03, 1, 'take_innsta_0.03', 9, 27],
                    1:[100000, 102000, 111000, 175000, 1, 0, 0.04, 1, 'take_innsta_0.02', 9, 27],
                    2:[100000, 110000, 122000, 171000, 1, 0, 0.04, 1, 'take_innsta_0.03', 14, 27],
                    3:[100000, 101000, 114000, 175000, -1, 0, 0.03, 1, 'take_innsta_0.02', 27, 0],
                    4:[100000, 121000, 122000, 162000, 1, 0, 0.04, 1, 'take_innsta_0.02', 27, 0],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
