...
logging.config.fileConfig('log_magn.conf')
log=logging.getLogger('main')
from ProfileAnalyzer import ProfileAnalyser

class ProfileAnalyserMAGN(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[[100000, 101000, 102000, 180000, -1, 0, 0.02, 3, 'take_innsta_0.003', 14, 0],[100000, 101000, 113000, 173000, 1, 0, 0.02, 3, 'take_innsta_0.015', 14, 0]],
                    1:[[100000, 102000, 103000, 180000, -1, 0, 0.03, 4, 'take_innsta_0.015', 9, 0],[100000, 102000, 122000, 175000, 1, 0, 0.03, 4, 'take_innsta_0.01', 9, 0]],
                    2:[[100000, 103000, 104000, 150000, -1, 0, 0.04, 3, 'take_innsta_0.0075', 9, 0],[100000, 103000, 113000, 175000, 1, 0, 0.01, 3, 'take_innsta_0.02', 9, 0]],
                    3:[[100000, 101000, 102000, 180000, -1, 0, 0.03, 4, 'take_innsta_0.015', 20, 0],[100000, 101000, 150000, 180000, 1, 0, 0.03, 4, 'take_innsta_0.003', 20, 0]],
                    4:[[100000, 102000, 103000, 175000, -1, 0, 0.04, 4, 'take_innsta_0.003', 14, 27],[100000, 102000, 121000, 175000, 1, 0, 0.01, 4, 'take_innsta_0.003', 14, 27]],
...
if __name__ == "__main__":
    ...
    temp_file_name="daily_MAGN.txt"
    result_files=["C:\\Just2Trade Client\\Magnitogorskiy MK.txt","C:\\Just2Trade Client\\reserv_Magnitogorskiy MK.txt"]
