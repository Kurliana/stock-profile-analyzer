...
class ProfileAnalyserMGNT(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[100000, 103000, 111000, 132000, 1, 0, 0.03, 1, 'take_innsta_0.03', 27, 0],
                    1:[100000, 112000, 114000, 152000, 1, 0, 0.04, 1, 'take_innsta_0.04', 9, 27],
                    2:[100000, 113000, 114000, 175000, 1, 0, 0.04, 1, 'take_innsta_0.02', 27, 0],
                    3:[100000, 111000, 112000, 170000, 1, 0, 0.04, 0, 'take_innsta_0.03', 14, 27],
                    4:[100000, 102000, 110000, 143000, 1, 0, 0.03, 1, 'take_innsta_0.04', 27, 0],
                    5:[183000, 183000, 183000, 183000,1],
                    6:[183000, 183000, 183000, 183000,1]}
