            ...
            for more in more_less_list:
                for less in more_less_list:
                    if more < less:
                        ...
                        if total_sum > 1000 and float(day_count)/float(total_days) > 0.2:
...
if __name__ == "__main__":
    ...
    file_list=["my_app_super_full_bac_5_p3x3_fixed_success.log","my_app_super_full_bac_5_p3x3_diff_shorty.log"]
    for ranges in [[8,9]]:#,range(10,30,1),range(10,20,1)+range(30,40,1),range(0,10,1)+range(20,30,1),range(0,10,1)+range(30,40,1)]:
