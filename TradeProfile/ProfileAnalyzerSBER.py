...
logging.config.fileConfig('log_sber.conf')
log=logging.getLogger('main')
from ProfileAnalyzer import ProfileAnalyser

class ProfileAnalyserSBER(ProfileAnalyser):
    ...
    def get_ranges_by_dayweek_new(self,curr_date):
        day_of_week = self.get_day_week(curr_date)
        day_ranges={0:[[100000, 102000, 103000, 180000, -1, 0, 0.04, 3, 'take_innsta_0.01', 20, 0],[100000, 102000, 110000, 151000, 1, 0, 0.03, 3, 'take_innsta_0.0075', 20, 0]],
                    1:[[100000, 103000, 112000, 173000, -1, 0, 0.03, 2, 'take_innsta_0.01', 9, 0],[100000, 103000, 105000, 154000, 1, 0, 0.04, 2, 'take_innsta_0.003', 9, 0]],
                    2:[[100000, 102000, 103000, 175000, -1, 0, 0.01, 3, 'take_innsta_0.003', 20, 0],[100000, 102000, 113000, 175000, 1, 0, 0.01, 3, 'take_innsta_0.04', 20, 0]],
                    3:[[100000, 113000, 114000, 160000, -1, 0, 0.01, 3, 'take_innsta_0.03', 14, 0],[100000, 113000, 155000, 180000, 1, 0, 0.02, 3, 'take_innsta_0.015', 14, 0]],
                    4:[[100000, 102000, 111000, 180000, -1, 0, 0.04, 5, 'take_innsta_0.01', 9, 14],[100000, 102000, 132000, 165000, 1, 0, 0.02, 5, 'take_innsta_0.015', 9, 14]],
...
if __name__ == "__main__":
    ...
    temp_file_name="daily_SBER.txt"
    result_files=["C:\\Just2Trade Client\\Sberbank.txt","C:\\Just2Trade Client\\reserv_Sberbank.txt"]
    ...
    pa = ProfileAnalyserSBER(temp_file_name)
